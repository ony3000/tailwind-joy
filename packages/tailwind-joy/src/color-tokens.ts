export const token = {
  primary: {
    ...
    plainHoverBg: 'hover:bg-joy-primary-100 dark:hover:bg-joy-primary-800',
    plainActiveBg: 'active:bg-joy-primary-200 dark:active:bg-joy-primary-700',
    plainDisabledColor:
    ...
    outlinedHoverBg: 'hover:bg-joy-primary-100 dark:hover:bg-joy-primary-800',
    outlinedActiveBg:
    ...
    softHoverBg: 'hover:bg-joy-primary-200 dark:hover:bg-joy-primary-700',
    softActiveColor:
      'active:text-joy-primary-800 dark:active:text-joy-primary-100',
    softActiveBg: 'active:bg-joy-primary-300 dark:active:bg-joy-primary-600',
    softDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    softDisabledBg:
    ...
    solidHoverBg: 'hover:bg-joy-primary-600',
  ...
  neutral: {
    ...
    plainHoverBg: 'hover:bg-joy-neutral-100 dark:hover:bg-joy-neutral-800',
    plainActiveBg: 'active:bg-joy-neutral-200 dark:active:bg-joy-neutral-700',
    plainDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    ...
    outlinedHoverBg: 'hover:bg-joy-neutral-100 dark:hover:bg-joy-neutral-800',
    outlinedActiveBg:
    ...
    softHoverBg: 'hover:bg-joy-neutral-200 dark:hover:bg-joy-neutral-700',
    softActiveColor:
      'active:text-joy-neutral-800 dark:active:text-joy-neutral-100',
    softActiveBg: 'active:bg-joy-neutral-300 dark:active:bg-joy-neutral-600',
    softDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    softDisabledBg:
      'disabled:bg-joy-neutral-50 dark:disabled:bg-joy-neutral-800',
    ...
    solidHoverBg: 'hover:bg-joy-neutral-600',
  ...
  danger: {
    ...
    plainHoverBg: 'hover:bg-joy-danger-100 dark:hover:bg-joy-danger-800',
    plainActiveBg: 'active:bg-joy-danger-200 dark:active:bg-joy-danger-700',
    plainDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    ...
    outlinedHoverBg: 'hover:bg-joy-danger-100 dark:hover:bg-joy-danger-800',
    outlinedActiveBg: 'active:bg-joy-danger-200 dark:active:bg-joy-danger-700',
    outlinedDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    outlinedDisabledBorder:
      'disabled:border-joy-neutral-200 dark:disabled:border-joy-neutral-800',
    ...
    softHoverBg: 'hover:bg-joy-danger-200 dark:hover:bg-joy-danger-700',
    softActiveColor:
      'active:text-joy-danger-800 dark:active:text-joy-danger-100',
    softActiveBg: 'active:bg-joy-danger-300 dark:active:bg-joy-danger-600',
    softDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    softDisabledBg:
      'disabled:bg-joy-neutral-50 dark:disabled:bg-joy-neutral-800',
    ...
    solidHoverBg: 'hover:bg-joy-danger-600',
  ...
  success: {
    ...
    plainHoverBg: 'hover:bg-joy-success-100 dark:hover:bg-joy-success-800',
    plainActiveBg: 'active:bg-joy-success-200 dark:active:bg-joy-success-700',
    plainDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    ...
    outlinedHoverBg: 'hover:bg-joy-success-100 dark:hover:bg-joy-success-800',
    outlinedActiveBg:
    ...
    softHoverBg: 'hover:bg-joy-success-200 dark:hover:bg-joy-success-700',
    softActiveColor:
      'active:text-joy-success-800 dark:active:text-joy-success-100',
    softActiveBg: 'active:bg-joy-success-300 dark:active:bg-joy-success-600',
    softDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    softDisabledBg:
      'disabled:bg-joy-neutral-50 dark:disabled:bg-joy-neutral-800',
    ...
    solidHoverBg: 'hover:bg-joy-success-600',
  ...
  warning: {
    ...
    plainHoverBg: 'hover:bg-joy-warning-100 dark:hover:bg-joy-warning-800',
    plainActiveBg: 'active:bg-joy-warning-200 dark:active:bg-joy-warning-700',
    plainDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    ...
    outlinedHoverBg: 'hover:bg-joy-warning-100 dark:hover:bg-joy-warning-800',
    outlinedActiveBg:
    ...
    softHoverBg: 'hover:bg-joy-warning-200 dark:hover:bg-joy-warning-700',
    softActiveColor:
      'active:text-joy-warning-800 dark:active:text-joy-warning-100',
    softActiveBg: 'active:bg-joy-warning-300 dark:active:bg-joy-warning-600',
    softDisabledColor:
      'disabled:text-joy-neutral-400 dark:disabled:text-joy-neutral-500',
    softDisabledBg:
      'disabled:bg-joy-neutral-50 dark:disabled:bg-joy-neutral-800',
    ...
    solidHoverBg: 'hover:bg-joy-warning-600',
