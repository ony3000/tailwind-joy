...
export function ButtonDecorators() {
  return (
    <DisplayStand>
      <Button
        color="primary"
        startDecorator={<MdAdd className={iconClass({ color: 'primary' })} />}
      >
        Add to cart
      </Button>
      <Button
        color="success"
        endDecorator={
          <MdKeyboardArrowRight className={iconClass({ color: 'success' })} />
        }
      >
        Go to checkout
      </Button>
...
import { Button, iconClass } from 'tailwind-joy/components';
  ...
  return (
    <DisplayStand>
      ...
      <Button
        loading
        loadingPosition="end"
        endDecorator={<MdSend className={iconClass({ color: 'primary' })} />}
      >
        End
      </Button>
    </DisplayStand>
...
import { IconButton, iconClass } from 'tailwind-joy/components';
