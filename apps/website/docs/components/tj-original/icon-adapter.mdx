...
For Joy UI, you are instructed to define global styles to [integrate third-party icon libraries with Joy UI components](https://v5.mui.com/joy-ui/integrations/icon-libraries/#third-party-icons).
...
So, I created this component to enable [&ldquo;Automatic adjustment&rdquo;](https://v5.mui.com/joy-ui/main-features/automatic-adjustment/) feature while avoiding the side effects that can occur with global style definitions.
