...
export function DividerVerticalDivider() {
  const iconClassName =
    'select-none m-[var(--Icon-margin)] w-[1em] h-[1em] inline-block shrink-0 [font-size:var(--Icon-fontSize,1.5rem)] [color:var(--Icon-color,var(--joy-neutral-500))] dark:[color:var(--Icon-color,var(--joy-neutral-400))]';
  return (
    <DisplayStand>
      <div className="bg-joy-neutral-50 dark:bg-joy-neutral-900 text-joy-neutral-700 dark:text-joy-neutral-300 border-joy-neutral-500/20 dark:border-joy-neutral-400/20 flex w-fit items-center rounded-md border border-solid [&_hr]:mx-1 [&_svg]:m-3">
        <MdFormatAlignLeft className={iconClassName} />
        <MdFormatAlignCenter className={iconClassName} />
        <MdFormatAlignRight className={iconClassName} />
