...
So, I created this function to enable [&ldquo;Automatic adjustment&rdquo;](https://v5.mui.com/joy-ui/main-features/automatic-adjustment/) feature while avoiding the side effects that can occur with global style definitions.
